...
const EmptyChat = () => {
    ...
    const url1 = 'https://ik.imagekit.io/ag/wp-content/uploads/2015/01/QR-connected.png';
    const URL='https://upload.wikimedia.org/wikipedia/commons/thumb/6/6b/WhatsApp.svg/1200px-WhatsApp.svg.png'
    return (
        <Box className={classes.component}>
            <Box className={classes.container}>
                <img src={url1} alt="dp" className={classes.image} />
